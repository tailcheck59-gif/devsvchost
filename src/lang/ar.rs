...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة DevSvcHost..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. DevSvcHost قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت DevSvcHost في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح DevSvcHost اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح DevSvcHost اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ DevSvcHost باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [DevSvcHost Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep DevSvcHost background service", "ابق خدمة DevSvcHost تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق DevSvcHost, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show DevSvcHost", "عرض DevSvcHost"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من DevSvcHost اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح DevSvcHost اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في DevSvcHost الذي يعمل."),
        ...
        ("verify_DevSvcHost_password_tip", "تحقق من كلمة مرور DevSvcHost"),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "ترقية خادم DevSvcHost Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع DevSvcHost"),
        ...
        ("About DevSvcHost", "حول DevSvcHost"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "ترقية عميل DevSvcHost البعيد إلى {}"),
