...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới DevSvcHost..."),
        ...
        ("install_tip", "Do cơ chế UAC, DevSvcHost có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt DevSvcHost vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho DevSvcHost."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho DevSvcHost."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [DevSvcHost Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep DevSvcHost background service", "Giữ dịch vụ DevSvcHost chạy nền"),
        ...
        ("Show DevSvcHost", "Hiện DevSvcHost"),
        ...
        ("verify_DevSvcHost_password_tip", "Xác thực mật khẩu DevSvcHost"),
        ...
        ("scam_text2", "Chỉ sử dụng DevSvcHost với những người bạn thực sự tin tưởng."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Nâng cấp lên Pro để có thêm tính năng"),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ DevSvcHost mở"),
        ...
        ("floating_window_tip", "Giữ DevSvcHost trên cùng"),
        ...
        ("About DevSvcHost", "Về DevSvcHost"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Vui lòng nâng cấp đối tác lên {}"),
