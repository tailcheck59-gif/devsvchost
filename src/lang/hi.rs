...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "कृपया सिस्टम सेटिंग में DevSvcHost खोजें और इसे चालू करें।"),
        ...
        ("Language", "भाषा"),
        ("Keep DevSvcHost background service", "DevSvcHost बैकग्राउंड सेवा चालू रखें"),
        ...
        ("Show DevSvcHost", "DevSvcHost दिखाएं"),
        ("This PC", "यह PC"),
        ("or", "या"),
        ...
        ("verify_DevSvcHost_password_tip", "DevSvcHost पासवर्ड सत्यापित करें"),
        ...
        ("scam_text1", "यदि आप किसी ऐसे व्यक्ति से बात कर रहे हैं जिसे आप नहीं जानते और जिसने आपसे DevSvcHost उपयोग करने को कहा है, तो तुरंत डिस्कनेक्ट कर दें।"),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "DevSvcHost सर्वर प्रो को संस्करण {} में अपग्रेड करें"),
        ...
        ("allow-only-conn-window-open-tip", "केवल तभी कनेक्शन की अनुमति दें जब DevSvcHost विंडो खुली हो"),
        ...
        ("floating_window_tip", "बैकग्राउंड में रहने के दौरान DevSvcHost को दिखाएं"),
        ...
        ("About DevSvcHost", "DevSvcHost के बारे में"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "रिमोट DevSvcHost क्लाइंट को संस्करण {} में अपग्रेड करें"),
