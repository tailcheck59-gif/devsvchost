...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke DevSvcHost..."),
        ...
        ("install_tip", "Karena UAC, DevSvcHost tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal DevSvcHost ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk DevSvcHost."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk DevSvcHost."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android melalui mouse atau sentuhan, Kamu harus memberikan izin/permission kd DevSvcHost untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input DevSvcHost]."),
        ...
        ("Language", "Bahasa"),
        ("Keep DevSvcHost background service", "Pertahankan DevSvcHost berjalan pada service background"),
        ...
        ("Show DevSvcHost", "Tampilkan DevSvcHost"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ("Elevate", "Elevasi"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada DevSvcHost"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada DevSvcHost"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC DevSvcHost yang sedang berjalan"),
        ...
        ("verify_DevSvcHost_password_tip", "Verifikasi Kata Sandi DevSvcHost"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan DevSvcHost, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Silahkan perbarui DevSvcHost Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah DevSvcHost berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh DevSvcHost"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela DevSvcHost sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service DevSvcHost agar tetap aktif"),
        ...
        ("About DevSvcHost", "Tentang DevSvcHost"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Silahkan perbarui aplikasi DevSvcHost ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
