...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "DevSvcHosti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa DevSvcHost mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et DevSvcHost oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb DevSvcHostile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb DevSvcHostile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma DevSvcHostile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [DevSvcHost Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep DevSvcHost background service", "Säilita DevSvcHosti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele DevSvcHosti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show DevSvcHost", "Kuva DevSvcHost"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma DevSvcHostile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma DevSvcHostile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud DevSvcHosti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_DevSvcHost_password_tip", "Kinnita DevSvcHosti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul DevSvcHosti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Palun täienda DevSvcHost Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib DevSvcHostil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb DevSvcHostil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui DevSvcHosti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada DevSvcHosti taustateenust."),
        ...
        ("About DevSvcHost", "DevSvcHosti teave"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Täiendage DevSvcHosti klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
