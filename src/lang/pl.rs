...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "DevSvcHost może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować DevSvcHost w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić DevSvcHost przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić DevSvcHost na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [DevSvcHost Input]."),
        ...
        ("Language", "Język"),
        ("Keep DevSvcHost background service", "Zachowaj usługę DevSvcHost w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji DevSvcHost, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show DevSvcHost", "Pokaż DevSvcHost"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji DevSvcHost uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać DevSvcHost uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z DevSvcHost w Twojej sieci."),
        ...
        ("verify_DevSvcHost_password_tip", "Weryfikuj hasło DevSvcHost"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu DevSvcHost - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Proszę zaktualizować DevSvcHost Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu DevSvcHost po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez DevSvcHost"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno DevSvcHost jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę DevSvcHost w tle"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Proszę zaktualizować zdalny klient DevSvcHost do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie DevSvcHost weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, DevSvcHost pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, DevSvcHost nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
        ("server-oss-not-support-tip", "UWAGA: Serwer OSS DevSvcHost nie obsługuje tej funkcji."),
