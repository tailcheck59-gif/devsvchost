...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään DevSvcHost verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa DevSvcHost ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi DevSvcHostin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava DevSvcHostille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava DevSvcHostille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten DevSvcHost daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota DevSvcHostille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli DevSvcHost ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "DevSvcHost palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa DevSvcHostin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "DevSvcHost palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep DevSvcHost background service", "Pidä DevSvcHostin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista DevSvcHostin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show DevSvcHost", "Näytä DevSvcHost"),
        ...
        ("verify_DevSvcHost_password_tip", "Vahvista DevSvcHost salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "DevSvcHost ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Päivitä DevSvcHost Server Pro versioon {} jatkaaksesi."),
        ...
        ("About DevSvcHost", "Tietoa DevSvcHostistä"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Päivitä etä-DevSvcHost-asiakasversioon {} yhteensopivuuden takaamiseksi"),
