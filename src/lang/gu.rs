...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "કૃપા કરીને સેટિંગ્સમાં DevSvcHost શોધો અને તેને ચાલુ કરો."),
        ...
        ("Language", "ભાષા"),
        ("Keep DevSvcHost background service", "DevSvcHost બેકગ્રાઉન્ડ સેવા ચાલુ રાખો"),
        ...
        ("Show DevSvcHost", "DevSvcHost બતાવો"),
        ("This PC", "આ PC"),
        ("or", "અથવા"),
        ("Elevate", "એલિવેટ કરો"),
        ...
        ("verify_DevSvcHost_password_tip", "DevSvcHost પાસવર્ડ ચકાસો"),
        ...
        ("scam_text1", "જો તમે અજાણી વ્યક્તિ સાથે વાત કરી રહ્યા હો અને તેણે DevSvcHost વાપરવા કહ્યું હોય, તો તરત ડિસ્કનેક્ટ કરો."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "સર્વર પ્રો ને {} માં અપગ્રેડ કરો"),
        ...
        ("allow-only-conn-window-open-tip", "માત્ર DevSvcHost વિન્ડો ખુલ્લી હોય ત્યારે જ કનેક્શનની મંજૂરી આપો"),
        ...
        ("floating_window_tip", "બેકગ્રાઉન્ડમાં હોય ત્યારે DevSvcHost બતાવો"),
        ...
        ("About DevSvcHost", "DevSvcHost વિશે"),
        ...
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "રિમોટ ક્લાયન્ટને {} માં અપગ્રેડ કરો"),
