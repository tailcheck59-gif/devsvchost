...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem DevSvcHost..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, DevSvcHost v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate DevSvcHostu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate DevSvcHostu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno DevSvcHostu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »DevSvcHost Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep DevSvcHost background service", "Ohrani DevSvcHostovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije DevSvcHost, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "DevSvcHost potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "DevSvcHost potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_DevSvcHost_password_tip", "Preveri geslo za DevSvcHost"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite DevSvcHost, prekinite klic in program zaprite."),
        ("scam_text2", "DevSvcHost omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_DevSvcHost_server_pro_to_{}_tip", "Prosimo, nadgradite DevSvcHost Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo DevSvcHost"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno DevSvcHosta odprto"),
        ...
        ("floating_window_tip", "Pomaga pri DevSvcHost storitvi v ozadju"),
        ...
        ("About DevSvcHost", "O DevSvcHostu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_DevSvcHost_client_to_{}_tip", "Prosimo, nadgradite DevSvcHost odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
