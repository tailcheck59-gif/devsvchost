...
const url = '';  // Fork: removed upstream homepage link.
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep DevSvcHost background service')),
      ...
      sections: [
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            // Fork: removed upstream Privacy Statement tile (no privacy page).
          ],
        ),
      ],
    );
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About DevSvcHost')),
      content: Wrap(direction: Axis.vertical, spacing: 12, children: [
        Text('Version: $version'),
        // Fork: removed upstream rustdesk.com link from About dialog.
      ]),
      actions: [],
    );
